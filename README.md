...
## Dataset
The dataset used for this project is a financial dataset containing transaction records and budget-related data. It includes information on revenue sources, expenses, vendors, departments, monthly transactions, and allocated budgets used to evaluate financial performance and variance analysis.
...
Monthly analysis revealed that spending remained largely within budget in January, February, April, and May. From June onward, expenses generally exceeded planned amounts, with July recording the most significant budget overrun, while November remained within budget.
...
![Financial Overview](Dashboard_images/Financial_overview.png)

### Expense Analysis Dashboard
![Expense Analysis](Dashboard_images/Expense_analysis.png)

### Insights & Recommendations
![Insights Page](Dashboard_images/Insights.png)
